...
func countWetSpots(theMap *groundMap) (int, int) {
	flowing, pooled := 0, 0
...
func main() {
	...
	flowing, pooled := countWetSpots(theMap)

	fmt.Printf("steps run: %d\n", stepsRun)
	fmt.Printf("total wet spots: %d\n", flowing+pooled)
	fmt.Printf("pooled spots: %d\n\n", pooled)
